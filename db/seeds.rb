...
puts "Seeding users"
user1 = User.create!(email: "lalala@gmail.com", password: "hellocucumber", first_name: "Jane", last_name: "Smith", user_name: "sweetpea121")
user2 = User.create!(email: "somebody@gmail.com", password: "password123", first_name: "John", last_name: "Doe", user_name: "luv2hike")
user3 = User.create!(email: "dallas@hotmail.com", password: "yeehaw2020",first_name: "Abby", last_name: "Hall", user_name: "Diamond Eye")
